...
const ExpenseGroupDialog = (props) => {
  ...
  const onSubmit = async () => {
    if (values.name === "") {
      ...
      if (props.value) {
        await ExpenseGroupService.update(
          {
            id: props.value.id,
            name: values.name,
        ...
        await ExpenseGroupService.create(
          {
            name: values.name,
            description: values.description,
          },
...
export default connect(mapStateToProps, null)(ExpenseGroupDialog);
