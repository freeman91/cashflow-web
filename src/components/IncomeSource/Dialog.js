  ...
  return (
    ...
    >
      <DialogTitle id="dialog-title" className={classes.title}>
        {value ? 'Edit Income Source' : 'Create Income Source'}
      </DialogTitle>
      <DialogContent>
...
export default connect(mapStateToProps, mapDispatchToProps)(IncomeSourceDialog);
