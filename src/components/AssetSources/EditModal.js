...
import AssetSource from '../../service/AssetSourceService';
...
class EditModal extends Component {
  ...
  handleDelete = () => {
    AssetSource.destroy(this.state.value.id, this.props.user.auth_token).then(
      (response) => {
  ...
  render() {
    ...
    return (
      <Modal isOpen={open} toggle={handleClose} modalClassName="modal-info">
        <ModalHeader>Edit Asset Source</ModalHeader>
        <ModalBody>
          <InputGroup>
